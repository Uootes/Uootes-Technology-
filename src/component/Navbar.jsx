...
const Navbar = () => {
    ...
    return (
        <nav className="w-full bg-gradient-to-r from-blue-900 to-black fixed top-0 left-0 z-90">
            <div className="container flex justify-between items-center md:px-4">
                ...
                <div className="md:hidden pr-8">
                    ...
                    >
                        {isMenuOpen ? <FaTimes className="w-6 h-6" /> : <FaBars className="w-6 h-6" />} {/* Toggle icon */}
                    </button>
                </div>
            </div>
            ...
            {/* Mobile Menu */}
            {isMenuOpen && (
                <div className="md:hidden text-2xl pl-4 pb-4 bg-transparent">
                    <ul>
