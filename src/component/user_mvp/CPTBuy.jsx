    ...
    <div className='text-white h-screen bg-black flex flex-col justify-between'>
        <div>
            ...
            <div className='w-full flex items-center text-center justify-center'>
                <h2 className=' text-[30px] font-bold'>Buy</h2>
            </div>
            ...
            {/* Error message for insufficient balance */}
                <h5 className='text-red-500 font-bold text-[20px]'>Insufficient</h5>
                ...
                <h2 className='text-[35px] font-bold'>GSC {Buyprice}.00</h2>
            </div>
        </div>
        <div className='w-full pb-8 flex justify-center items-center'>
            <button className='w-[90%] lg:w-[50%] h-[60px] bg-green-600 text-[25px] font-bold rounded-2xl'>Buy</button>
        </div>
    </div>
  )
}

export default CPTBuy