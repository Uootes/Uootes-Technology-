...
const withdrawalData = [
  ...
  return (
    <div className="h-['100px'] w-full bg-black text-white px-4 py-16 rounded-md hover:bg-slate-900" id='history'>
      <div className="text-center text-2xl font-bold mb-6 pt-2 hover:text-green-100">History</div>
      ...
      <div className='flex flex-wrap justify-center gap-6'>
        {activeTab === 'deposit' ? depositData.map((d, i) => <DepositCard key={i} {...d} />)
