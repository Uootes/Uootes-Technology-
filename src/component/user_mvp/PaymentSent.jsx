...
export default function PaymentSent({ amount = '$100.00', timer = '29:59', onRelease }) {
  return (
        <div className="h-['100px'] w-full bg-black flex flex-col items-center px-4 py-16 rounded-md hover:bg-slate-900" id='paymentsent'>
            {/* Progress */}
            ...
            {/* Title */}
            {/* Title */}
            <h1 className="text-white text-2xl font-bold mt-8 hover:text-green-100 marker:">Payment Sent</h1>
            ...
            <div className="bg-gray-800 rounded-xl border border-gray-600 p-6 my-6 max-w-xl w-full">
                ...
                <p className="text-gray-300 leading-relaxed mt-4 hover:text-green-100">
